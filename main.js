...
const quotes = ['JOIN THE DISCOOOORD','I\'m in me mums car! Broom Broom!','Just smile through the feels:\')','Fuck the system, and do what you want',
'Fox head. Fox head. Fuck head. Fox head. Fox head.','You guys are the art.','Where did my teeth go?','Oh, shut up, fridge.','Please HELP ME, I''m gonna die:D',
'Everything is possible, and there are no rules or answers to anything.','FUCK OFF THOMPSON I\'LL LONG NECK DECK YOU!','Fuck you, hurdle.',
'Middle finger to it all. Fuck you!','Sometimes Bird Daddy just fuckin freaks out, y\'know?','Do you wanna be SASSY with me tonight?','What\'s my opinion on the color orange? NOT A THIIIING!',
'GOOD LUCK BESTIES','I think I finally broke the discord','I was born....and I lived...and now I\'m still living.',
'The discord is just basically a place where I can receive cyber bullying.','I decided a long time ago that I deserve to be bullied.','I\'ll simp for bird daddy'];
