...
module.exports = {
    ...
    async execute(message, profileData){
        ...
        .then(function (msg) {
            ...
            message.channel.awaitMessages({filter: m => m.author.id == message.author.id, time: 1000 * 60 * 7, max:1}).then(collected => {                
                if (gameOver){
                    return;
                }
